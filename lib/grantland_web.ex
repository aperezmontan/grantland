defmodule GrantlandWeb do
  ...
  def controller do
    quote do
      use Phoenix.Controller, namespace: GrantlandWeb

      import Plug.Conn
      import GrantlandWeb.Gettext
  ...
  def view do
    quote do
      use Phoenix.View,
        root: "lib/grantland_web/templates",
        namespace: GrantlandWeb
  ...
  defp view_helpers do
    quote do
      ...
      import GrantlandWeb.ErrorHelpers
      import GrantlandWeb.Gettext
      alias GrantlandWeb.Router.Helpers, as: Routes
    end
  end
