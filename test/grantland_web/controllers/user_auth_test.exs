defmodule GrantlandWeb.UserAuthTest do
  use GrantlandWeb.ConnCase, async: true

  alias Grantland.Identity
  alias GrantlandWeb.UserAuth
  import Grantland.IdentityFixtures

  @remember_me_cookie "_grantland_web_user_remember_me"

  setup %{conn: conn} do
    conn =
      conn
      |> Map.replace!(:secret_key_base, GrantlandWeb.Endpoint.config(:secret_key_base))
      |> init_test_session(%{})
  ...
  describe "logout_user/1" do
    ...
    test "broadcasts to the given live_socket_id", %{conn: conn} do
      ...
      GrantlandWeb.Endpoint.subscribe(live_socket_id)
